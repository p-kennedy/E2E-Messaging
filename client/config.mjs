...
export const SERVER_HOST = process.env.SERVER_HOST ?? '200.69.13.70';
export const SERVER_PORT = process.env.SERVER_PORT ? Number(process.env.SERVER_PORT) : 2213;
export const SERVER_URL  = process.env.SERVER_URL  ?? `https://${SERVER_HOST}:${SERVER_PORT}`;
